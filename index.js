...
let class_toggle = (element, classes_to_remove, classes_to_add) => {
    ...
    if (Array.isArray(classes_to_add))
        element.classList.add(...classes_to_add);
    else
        element.classList.add(classes_to_add);
}
...
document.addEventListener("DOMContentLoaded", function() {
    class_toggle(font_changer_test, Object.keys(font_families), font_families_select.value)
});
